/* ---------------------------------------------------------------------- */
/*  On.Bingo Master Data & Pricing Comparisons                           */
/* ---------------------------------------------------------------------- */

export const SOFTWARE_CHAOS_APPS = [
  { name: "Salesforce / HubSpot CRM", avgPrice: "$99/mo", category: "CRM & Pipelines", icon: "💼" },
  { name: "ClickFunnels / Leadpages", avgPrice: "$97/mo", category: "Funnel & Page Builder", icon: "⚡" },
  { name: "Klaviyo / Mailchimp", avgPrice: "$39/mo", category: "Email Marketing", icon: "✉️" },
  { name: "ActiveCampaign / Zapier", avgPrice: "$79/mo", category: "Marketing Automation", icon: "⚙️" },
  { name: "WordPress / Webflow", avgPrice: "$25/mo", category: "Website Hosting", icon: "🌐" },
  { name: "Intercom / Drift", avgPrice: "$29/mo", category: "Live Chat & Support", icon: "💬" },
  { name: "Calendly / Acuity", avgPrice: "$15/mo", category: "Appointment Booking", icon: "📅" },
  { name: "Google Analytics / Mixpanel", avgPrice: "$40/mo", category: "BI & Analytics", icon: "📊" },
];
...
export const MOVEMENT_METRICS = [
  { value: "500,000+", label: "Active Businesses", icon: "🏢" },
  { value: "$1.4 Billion+", label: "Pipeline Managed", icon: "💰" },
  { value: "120 Million+", label: "Automated Messages", icon: "⚡" },
  { value: "185+", label: "Countries Represented", icon: "🌐" }
];
